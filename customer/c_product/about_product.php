...
<body>
  ...
  <div>
    ...
    <?php echo '<img   src="data:image/jpeg;base64,' . base64_encode($row['file']) . '" alt="" class="responsive"  > '; ?>
    <div class="responsive">
      ...
      <?php echo $row['product_prize']; ?>
      <br>
      <br>
      <label>Product avalible size :</label>
      <?php echo $row['size']; ?>
      <br>
      <br>
      ...
      <label  class="btn btn-info b1 ">QUANTITY:</label>
        <input type="number" class="btn btn-info b1 "  name="quantity" value="1" min="1" max="<?= $row['quantity'] ?>" placeholder="Quantity"
          required>
        <input type="hidden" name="product_id" value="<?= $row['productid'] ?>"><BR><BR>
        <input type="submit" class="btn btn-info b1 " value="Add To Cart">
      </form>
