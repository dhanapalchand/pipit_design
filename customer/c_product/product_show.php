...
.clearfix:after {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      echo ' <a  href="about_product.php?id=' . $row["productid"] . '">
      <div class="responsive">
      <div class="gallery">
      <a  href="about_product.php?id=' . $row["productid"] . '">
          
            <img   src="data:image/jpeg;base64,' . base64_encode($row['file']) . '" alt="" width="300" height="400" >
           
            </a>
            <div class="desc">PRODUCT NAME : '.$row["product_name"].'</div>
          </div>
          </div>
';
      ?>
